...
Hello! This is a table of all the NYC Election Districts (read: precincts)! I cleaned and edited it based on multiple data requests from the [NYC Board of Elections](https://vote.nyc/). 
